...
namespace about {
    // 原有的内容获取函数
    static std::string get_help_documentation();
    static std::string get_online_help_documentation();
    static std::string get_about_information();
    static std::string get_about_information_online_link();
    static std::string get_about_update_information();
    static std::string get_about_update_information_online_link();
